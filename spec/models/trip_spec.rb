...
describe Trip do
  ...
  context 'class methods' do
    ...
    it 'calculates the Station with the most rides as a starting place' do
      ...
      trip_1 = Trip.create!(duration:8, start_date:'8/8/2010', start_station_id: 1, end_date: '8/9/2010', end_station_id: 1, bike_id: 4, subscription_type: "Subscriber", zip_code: 22207)
      trip_1 = Trip.create!(duration:8, start_date:'8/8/2010', start_station_id: 1, end_date: '8/9/2010', end_station_id: 1, bike_id: 4, subscription_type: "Subscriber", zip_code: 22207)
      trip_2 = Trip.create!(duration:9, start_date:'8/9/2010', start_station_id: station_2.id, end_date: '8/10/2010', end_station_id: 2, bike_id: 5, subscription_type: "Customer", zip_code: 22406)
      trip_2 = Trip.create!(duration:9, start_date:'8/9/2010', start_station_id: station_2.id, end_date: '8/10/2010', end_station_id: 2, bike_id: 5, subscription_type: "Customer", zip_code: 22406)
      trip_3 = Trip.create!(duration:10, start_date:'8/10/2010', start_station_id: station_2.id, end_date: '8/11/2010', end_station_id: 2, bike_id: 6, subscription_type: "Subscriber", zip_code: 22201)
      trip_3 = Trip.create!(duration:10, start_date:'8/10/2010', start_station_id: station_2.id, end_date: '8/11/2010', end_station_id: 2, bike_id: 6, subscription_type: "Subscriber", zip_code: 22201)
      trip_4 = Trip.create!(duration:5, start_date:'8/10/2010', start_station_id: station_2.id, end_date: '8/11/2010', end_station_id: 2, bike_id: 6, subscription_type: "Subscriber", zip_code: 22201)
      trip_4 = Trip.create!(duration:5, start_date:'8/10/2010', start_station_id: station_2.id, end_date: '8/11/2010', end_station_id: 2, bike_id: 6, subscription_type: "Subscriber", zip_code: 22201)

      expect(Trip.station_start_max).to eq('world')
    end
    it 'calculates the Station with the most rides as an ending place' do
      station_2 = Station.create(name: 'world', dock_count: 3, city:'Chicago', installation_date:'8/7/2010')
      trip_1 = Trip.create!(duration:8, start_date:'8/8/2010', start_station_id: station_2.id, end_date: '8/9/2010', end_station_id: 1, bike_id: 4, subscription_type: "Subscriber", zip_code: 22207)
      trip_1 = Trip.create!(duration:8, start_date:'8/8/2010', start_station_id: station_2.id, end_date: '8/9/2010', end_station_id: 1, bike_id: 4, subscription_type: "Subscriber", zip_code: 22207)
    ...
    it 'calculates the Most ridden bike with total number of rides for that bike' do
      ...
      expect(Trip.most_rides_on_one_bike).to eq(4)
    end
    it 'calculates the Least ridden bike with total number of rides for that bike' do
      ...
      expect(Trip.least_rides_on_one_bike).to eq(2)
    end
    ...
    it 'calculates the Single date with the highest number of trips with a count of those trips, and that dates weather' do
      trip_1 = Trip.create!(duration:8, start_date:'8/1/2010', start_station_id: 1, end_date: '8/9/2010', end_station_id: 1, bike_id: 6, subscription_type: "Subscriber", zip_code: 22207)
    ...
    it 'calculates the Single date with the lowest number of trips with a count of those trips, and that dates weather' do
      trip_1 = Trip.create!(duration:8, start_date:'8/1/2010', start_station_id: 1, end_date: '8/9/2010', end_station_id: 1, bike_id: 6, subscription_type: "Subscriber", zip_code: 22207)
      trip_2 = Trip.create!(duration:9, start_date:'8/1/2010', start_station_id: 2, end_date: '8/10/2010', end_station_id: 1, bike_id: 5, subscription_type: "Customer", zip_code: 22406)
      trip_3 = Trip.create!(duration:10, start_date:'8/1/2010', start_station_id: 2, end_date: '8/11/2010', end_station_id: 1, bike_id: 6, subscription_type: "Subscriber", zip_code: 22201)
      ...
      expect(Trip.least_trips_weather).to eq(condition_1)
    end
