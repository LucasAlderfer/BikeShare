...
describe 'User' do
  it 'visits the conditions dashboard' do
    ...
    expect(page).to have_content("Highest number of rides during wind speed between 0-4 mph: 2")
    expect(page).to have_content("Average number of rides during wind speed between 0-4 mph: 1.5")
    expect(page).to have_content("Lowest number of rides during wind speed between 0-4 mph: 1")
    expect(page).to have_content("Highest number of rides during wind speed between 4-8 mph: 2")
    expect(page).to have_content("Average number of rides during wind speed between 4-8 mph: 1.5")
    expect(page).to have_content("Lowest number of rides during wind speed between 4-8 mph: 1")
    expect(page).to have_content("Highest number of rides during mean visibility: 2")
    expect(page).to have_content("Average number of rides during mean visibility: 1.5")
    expect(page).to have_content("Lowest number of rides during mean visibility: 1")
  end
end
